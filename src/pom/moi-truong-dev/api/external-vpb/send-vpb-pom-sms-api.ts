...
export class VPBSendingAPI {
    request: APIRequestContext;
    baseURL: string = 'http://192.168.1.9:40013';
    ...
    async VPBSending(from: string, to: string, text: string, unicode: string, dlr: string, smsid: string, contentid: string) {
